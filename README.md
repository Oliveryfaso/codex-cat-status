...
- Running sprite: an active Codex conversation, an unfinished Codex tool/command call, or an active local job.
...
- `conversation`: the latest Codex turn has started and has not yet written `task_complete`.
- `pending`: unfinished tool or command calls in the latest Codex session.
